...
export function NotificationCenter() {
  ...
  const lastAi = useRef<{ credits: number; rate: number }>({ credits: 0, rate: 0 });
  useEffect(() => {
    return subscribeAiStatus((s) => {
      ...
      if (s === "credits") {
        ...
        push([{
          ...
          detail: "The AI Gateway is out of credits. Add credits in Settings → Workspace → Usage to resume press conferences, DMs, scouting and trade chatter.",
        }]);
      } else {
